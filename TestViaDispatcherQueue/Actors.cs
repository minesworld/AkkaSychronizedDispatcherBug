...
namespace AkkaSychronizedDispatcherBug
{
    public static class Creator
    {
        ...
        static public void CreateActorsDisplayingCounted_(DispatcherQueue dispatcherQueue, ICounted countable)
        {
            var displayRef = Instance.ActorOf(Props.Create(() => new CounterDisplayActor(dispatcherQueue, countable)));
    ...
    public partial class CounterDisplayActor : ReceiveActor
    {
        ...
        public CounterDisplayActor(DispatcherQueue dispatcherQueue, ICounted setable) : base() 
        {
